...
export const projects: ProjectData[] = [
    {
        ...
        image: '/src/assets/dots_logo.png',
        ...
        screens: [
            '/src/assets/dots_logo.png',
            '/src/assets/dots_billboard.png',
            '/src/assets/dots_businesscard.png',
        ],
        insights: [
    ...
    },
    {
        ...
        image: '/src/assets/scarface_poster.png',
        ...
        screens: ['/src/assets/scarface_poster.png'],
        insights: [
